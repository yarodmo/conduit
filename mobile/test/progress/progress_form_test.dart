...
void main() {
  ...
  // Local helpers (Dart forbids top-level/in-function getter declarations
  // — only valid as class members. Use functions instead.)
  ProgressFormController ctrl() =>
      container.read(progressFormControllerProvider.notifier);

  ProgressFormState state() =>
